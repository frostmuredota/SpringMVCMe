describe("Testing Register Form", function(){
	...
	describe("Valid radiobutton sex",function(){
		it("When radiobutton is not checked",function(){
			var checked = false;
			expect(validateSex(checked,"Please choise a sex")).toBeFalsy();
		})
		it("When radiobutton is checked",function(){
			var checked = true;
			expect(validateSex(checked,"Please choise a sex")).toBeTruthy();
		})
	});
	...
	describe("Valid input password",function(){
		it("When password is empty",function(){
			...
			var max = 8;
			var password = "";
			expect(validatePassword(password.length,min,max)).toBeFalsy();
		})
